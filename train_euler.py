...
def parse_args():
    ...
    parser.add_argument('-s', "--snapshot", default='/cluster/work/igp_psr/tmehmet/swiss_crop_model_ensemble/member_2003/swiss_map_star_4_16_0.001_6_128_2_0.1_0.3_0.0001_1_GT_labels_19_21_GP.csv_2003_epoch_24_model.pth',
