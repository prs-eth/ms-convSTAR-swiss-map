...
bsub -W 120:00 -n 1 -R "rusage[mem=120000,ngpus_excl_p=1]"  python3 train_ensemble.py --hidden 64 --seed 1005 -exp 1005 x
...
def parse_args():
    ...
    parser.add_argument(   '-c', "--checkpoint_dir", default='/cluster/work/igp_psr/tmehmet/swiss_crop_model_ensemble/member',
