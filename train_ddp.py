...
def main(
    ...
    if cell == 'lstm':
        ...
        network = multistageSTARSequentialEncoder(24, 24, nstage=stage, nclasses=nclasses,
                                                  ...
                                                  wo_softmax=True)
    #network_gt = model_2DConv(nclasses=nclasses, num_classes_l1=nclasses_local_1, num_classes_l2=nclasses_local_2,s1_2_s3=s1_2_s3, s2_2_s3=s2_2_s3, wo_softmax=True, dropout=dropout)
    network_gt = None
    ...
    if torch.cuda.is_available():
        ...
        #loss_local_1 = loss_local_1.to(device_ids[0])
        #loss_local_2 = loss_local_2.to(device_ids[0])
